...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Convert a RAD-like dataset tree to a JSONL manifest (paths-first).")
    ...
    parser.add_argument("--category", default="rad", help="Category label to stamp into the manifest")
