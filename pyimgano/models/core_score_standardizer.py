# -*- coding: utf-8 -*-
"""Score-standardizer wrapper for core (feature-matrix) detectors.

This is useful when combining multiple detectors or when you want a stable
score scale (e.g. [0,1] via rank/CDF).
"""
...
@register_model(
    ...
    tags=("classical", "core", "features", "wrapper", "calibration"),
    metadata={
        "description": "Wrap a core detector and standardize its scores (rank/zscore/robust/minmax)",
        "type": "wrapper",
    },
)
class CoreScoreStandardizer(BaseDetector):
    def __init__(
        self,
        *,
        base_detector: str | type | Any = "core_knn",
    ...
    def _build_base(self):
        ...
        if isinstance(spec, str):
            if spec == "core_score_standardizer":
                raise ValueError("core_score_standardizer cannot wrap itself")
            return create_model(
