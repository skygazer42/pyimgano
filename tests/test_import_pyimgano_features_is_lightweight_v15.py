...
def test_import_pyimgano_features_does_not_import_heavy_roots_by_default() -> None:
    payload = _run_py(
        r"""
import json
import sys
...
print(json.dumps({"present": present, "n_extractors": len(features.list_feature_extractors())}))
""",
    )
