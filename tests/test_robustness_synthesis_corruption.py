...
class _SynthesisLikeCorruption:
    ...
    def __call__(self, image, mask, *, severity: int, rng: np.random.Generator):  # noqa: ANN001, ANN201
        _ = (mask, severity)
        self._i += 1
        ...
        syn = AnomalySynthesizer(SynthSpec(preset="scratch", probability=1.0, blend="alpha", alpha=0.8))
