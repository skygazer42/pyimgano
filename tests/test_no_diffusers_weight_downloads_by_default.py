...
def test_diffusion_augmentor_defaults_to_local_files_only(monkeypatch) -> None:  # noqa: ANN001
    ...
    from pyimgano.utils.augmentation import DiffusionAugmentor, StableDiffusionImg2ImgPipeline, StableDiffusionPipeline
    ...
    monkeypatch.setattr(StableDiffusionPipeline, "from_pretrained", classmethod(_fake_from_pretrained), raising=True)
